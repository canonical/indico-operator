...
- [Fork](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks)
  our [GitHub repository](https://github.com/canonical/indico-operator)
...
Canonical welcomes contributions to the Indico Operator. Please check out our
...
OCI image for the Indico app, and then upload the image to a MicroK8s registry,
