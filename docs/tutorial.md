...
See more details in [Deploy the Nginx ingress integrator charm for the first time](https://documentation.ubuntu.com/nginx-ingress-integrator-charm/latest/howto/deploy-nginx-ingress-integrator/).
